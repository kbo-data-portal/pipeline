with game_dataset as (
    ...
    left join {{ ref('fct_team_recent_summary') }} as "home_recent" 
        on "schedule"."SEASON_ID" = "home_recent"."SEASON_ID" 
        and "schedule"."HOME_NM" = "home_recent"."TEAM_NM" 
        and to_date("schedule"."G_DT"::text, 'YYYYMMDD') = "home_recent"."G_DT" 
    left join {{ ref('fct_team_recent_summary') }} as "away_recent"
        on "schedule"."SEASON_ID" = "away_recent"."SEASON_ID" 
        and "schedule"."AWAY_NM" = "away_recent"."TEAM_NM" 
        and to_date("schedule"."G_DT"::text, 'YYYYMMDD') = "away_recent"."G_DT" 
