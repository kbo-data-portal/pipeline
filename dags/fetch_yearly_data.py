...
def run_scraper(**kwargs):
    ...
    game.run(target_season=season)


with DAG(
    dag_id="fetch_yearly_data",
    description="Fetches and uploads yearly KBO data",
    ...
    run_scraper_task >> load_data_task >> analytics_data_task
